    ...
    <div class="container">
        ...
        <div class="features">
            <div class="feature-card">
                ...
                <a href="{{ route('mostrarPartidos') }}" class="feature-button">Ver Ahora</a>
            </div>
            ...
            <div class="feature-card">
                ...
                <a href="{{ route('rangosLOL') }}" class="feature-button">Unirse</a>
            </div>
        </div>
        ...
        @if(!Auth::user() || Auth::user()->rol === 'cliente')
            <div class="classification-container">
                <div class="feature-card classification-card">
                    ...
                    <a href="{{ route('equiposOrdenadosPorPuntos') }}" class="feature-button">Ver Clasificación</a>
                </div>
            </div>
        @endif
        ...
        <div class="features">
            ...
            <div class="feature-card">
                ...
                <a href="{{ route('mostrarUsuarios') }}" class="feature-button">Administrar</a>
            </div>
